...
//   const currentProducts = repeatedProducts.slice(start, start + PRODUCTS_PER_PAGE);
...
//                 <button className="bg-white text-[#B88E2F] px-6 py-2 font-semibold mb-3">
//                   Add to cart
//                 </button>
...
//             {/* CONTENT */}
//             <div className="p-4 cursor-pointer" onClick={() => goToProduct(product.id)}>
